...
ModelEvaluationConfig, ModelPusherConfig, ModelTrainerConfig, TrainingPiplelineConfig
import os,sys
...
class Configuration:
    ...
    def __init__(self,
        config_file_path:str=CONFIG_FILE_PATH,                    #if we are not giving path then it will read config.yaml file
    ...
    def get_training_pipeline_config(self)->TrainingPiplelineConfig:
        ...
        try:
            ...
            training_pipeline_config=TrainingPiplelineConfig(artifact_dir=artifact_dir)
