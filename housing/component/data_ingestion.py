...
class DataIngestion:
    ...
    def download_housing_data(self)-> str:
        try:
            ...
            #complete full file path for the Zip file where will download
            tgz_file_path=os.path.join(tgz_download_dir,housing_file_name)

            logging.info(f"downloading file from url:[{download_url}] into [{tgz_file_path}]")
    ...
    def extract_tgz_file(self,tgz_file_path:str):
        try:
            ...
            #now have to read this tgz_file_path
    ...
    def split_data_as_train_test(self)-> DataIngestionArtifact:
        try:
            raw_data_dir=self.data_ingestion_config.raw_data_dir
            #now we have to find out file name
            ...
            #have to create train dataset
            logging.info(f"spliting data into train and test")
            strat_train_set=None
            strat_test_set=None

            #how many splits want to create
            split=StratifiedShuffleSplit(n_splits=1, test_size=0.2,random_state=42)

            #housing_data_frame["income_cat"] is specify the group
            ...
            #now save the information into the file
